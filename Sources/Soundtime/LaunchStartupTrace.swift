...
enum LaunchStartupMilestone: String, Sendable {
    ...
    case workspacePropertiesInitialized = "workspace-properties-initialized"
    case workspaceConfigured = "workspace-configured"
    case workspaceFirstPaintProjectCleared = "workspace-first-paint-project-cleared"
    case workspaceFirstPaintViewStateApplied = "workspace-first-paint-view-state-applied"
    case workspaceFirstPaintTracksPrepared = "workspace-first-paint-tracks-prepared"
    case workspaceFirstPaintStatePrepared = "workspace-first-paint-state-prepared"
    case workspaceFirstPaintTimelinePublished = "workspace-first-paint-timeline-published"
    case workspaceFirstPaintControlsPublished = "workspace-first-paint-controls-published"
    case workspaceFirstPaintDisplayTimingUpdated = "workspace-first-paint-display-timing-updated"
    case workspaceFirstPaintActiveTrackSynchronized = "workspace-first-paint-active-track-synchronized"
    case workspaceFirstPaintContentSynchronized = "workspace-first-paint-content-synchronized"
    case workspaceFirstPaintVisualReadinessRecorded = "workspace-first-paint-visual-readiness-recorded"
    case workspaceFirstPaintSourceRecorded = "workspace-first-paint-source-recorded"
